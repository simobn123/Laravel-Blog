...
@section('content')
    <div class="container mx-auto text-center pt-15 pb-5">
        <h1 class="text-6xl font-bold">Create New Blog</h1>
    </div>
    ...
    <div class="container mx-auto pt-15 pb-5">
        <form
            ...
            <input class="w-full h-20 text-6xl rounded-lg shadow-lg border-b p-5 mb-5" type="text" name="title" placeholder="title">
            <textarea class="w-full h-60 text-l rounded-lg shadow-lg border-b p-5 mb-5" name="description" placeholder="Description" ></textarea>
